...
- `service` - Name of the service (default: `""`)
- `owner` - Owner of the cluster (default: `""`)
- `expiration_date` - Date of expiration of the cluster and resources (default: `""`)
- `monitor` - Flag for monitoring resources in DataDog (default: `0`)
- `cost_center` - Cost center information for the cluster (default: `""`)
- `extra_tags` - Map of tags and values to associate with all resources (default: `{}`)
- `cluster_name` - Name of the cluster (default: `Default`)
- `datadog_api_key` - API key for Datadog (default: `""`)
